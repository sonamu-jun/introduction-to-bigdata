...
For later updates, use the GitHub guide: [Download and update the course files](https://github.com/sonamu-jun/introduction-to-bigdata/blob/main/01-0_Introduction/004_github_download_and_update.md).

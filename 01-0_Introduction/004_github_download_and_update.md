# GitHub: Download and Update the Course Files
...
## 1. Download the Course for the First Time
...
- `cd introduction-to-bigdata` opens the downloaded course folder.

You do not need to run `git clone` again for this course.

## 2. Get New Course Files: `git pull`
...
```bash
cd ~
git clone git@github.com:sonamu-jun/introduction-to-bigdata.git
cd introduction-to-bigdata
```
